DROP DATABASE IF EXISTS `records_ums`; 
DROP DATABASE IF EXISTS `records_qms`;  
DROP DATABASE IF EXISTS `records_sms`;
DROP DATABASE IF EXISTS `records_cms`;
DROP DATABASE IF EXISTS `records_chms`;

CREATE DATABASE records_ums CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
CREATE DATABASE records_qms CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
CREATE DATABASE records_sms CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
CREATE DATABASE records_cms CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
CREATE DATABASE records_chms CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
